    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kind', models.CharField(choices=[('ADMIN', 'Admin'), ('SUPER_ADMIN', 'Super Admin'), ('STUDENT', 'Student'), ('TEACHER', 'Teacher'), ('UNDEFINED', 'Undefined')], default='UNDEFINED', max_length=50)),
                ('status', models.CharField(choices=[('ACTIVE', 'Active'), ('DRAFT', 'Draft'), ('INACTIVE', 'Inactive')], default='DRAFT', max_length=50)),
